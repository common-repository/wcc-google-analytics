...
<div class="wcc-generate-api-box wcc-text-center">
  <form action="<?php echo esc_url(admin_url('admin.php?page=wcc-google-analytics')) ?>" method="post" class="wpforms-form">
    <div class="wcc-card">
      <div class="wcc-card-header"><h1 class="wcc-dashboard-title-1">Thank You</h1></div>
      <div class="wcc-card-body">
          <h3 class="wcc-card-title">WCC Google Analytics Dashboard</h3>
          <p class="wcc-card-text">Your key is generated and its ready to start.</p>
          <a class="wcc-dashboard-btn" href="<?php echo esc_url(admin_url('admin.php?page=wcc-google-analytics')) ?>">Get Started</a>
      </div>
    </div>
  </form>
</div>